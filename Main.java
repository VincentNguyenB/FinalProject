...
public class Main extends javax.swing.JFrame {
	...
	JPanel ClassPanel, WarriorClassPanel, MageClassPanel, ArcherClassPanel, ChooseClassScreenBackButtonPanel;
	JLabel CharacterClassLabel;
	JButton WarriorClassButton, MageClassButton, ArcherClassButton, ChooseClassScreenBackButton;
	...
	ChooseClassScreenBackHandler CCSBHandler = new ChooseClassScreenBackHandler();
	...
	public void PlayerCreationScreen() {
		...
		PlayerNameInput.setFont(new Font("Times New Roman", Font.PLAIN, 35));
		NameInputPanel.add(PlayerNameInput);
		
		EnterNameInput = new JButton("Enter");
		EnterNameInput.setBackground(Color.DARK_GRAY);
		EnterNameInput.setForeground(Color.white);
		EnterNameInput.setFont(new Font("Times New Roman", Font.PLAIN, 35));
		...
		PlayerCreationBackButton.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		...
		DifficultyEasy.setBackground(Color.gray);
		DifficultyEasy.setForeground(Color.white);
		DifficultyEasy.setFont(ButtonFont);
		...
		DifficultyMedium.setBackground(Color.gray);
		DifficultyMedium.setForeground(Color.white);
		DifficultyMedium.setFont(ButtonFont);
		...
		DifficultyHard.setFont(ButtonFont);
	...
	public void ChooseClassScreen() {
		...
		//------PANEL AND LABEL FOR THE PROMPT
		ClassPanel = new JPanel();
		ClassPanel.setBounds(100, 50, 600, 100);
		ClassPanel.setBackground(Color.gray);
		
		CharacterClassLabel = new JLabel("Choose your hero's class");
		CharacterClassLabel.setForeground(Color.white);
		CharacterClassLabel.setFont(new Font("Times New Roman", Font.PLAIN, 45));
		
		//------HERO'S CLASS BUTTONS AND PANELS
		WarriorClassPanel = new JPanel();
		WarriorClassPanel.setBounds(300, 200, 200, 50);
		WarriorClassPanel.setBackground(Color.gray);
		
		WarriorClassButton = new JButton("Warrior");
		WarriorClassButton.setBackground(Color.gray);
		WarriorClassButton.setForeground(Color.WHITE);
		WarriorClassButton.setFont(new Font("Times New Roman", Font.PLAIN, 30));
		
		MageClassPanel = new JPanel();
		MageClassPanel.setBounds(300, 300, 200, 50);
		MageClassPanel.setBackground(Color.gray);
		
		MageClassButton = new JButton("Mage");
		MageClassButton.setBackground(Color.gray);
		MageClassButton.setForeground(Color.WHITE);
		MageClassButton.setFont(new Font("Times New Roman", Font.PLAIN, 30));
		
		ArcherClassPanel = new JPanel();
		ArcherClassPanel.setBounds(300, 400, 200, 50);
		ArcherClassPanel.setBackground(Color.gray);
		
		ArcherClassButton = new JButton("Archer");
		ArcherClassButton.setBackground(Color.gray);
		ArcherClassButton.setForeground(Color.white);
		ArcherClassButton.setFont(new Font("Times New Roman", Font.PLAIN, 30));
		
		//------BACK BUTTON
		ChooseClassScreenBackButtonPanel = new JPanel();
		ChooseClassScreenBackButtonPanel.setBounds(50, 500, 100, 35);
		ChooseClassScreenBackButtonPanel.setBackground(Color.gray);
		
		ChooseClassScreenBackButton = new JButton("<<< Go Back");
		ChooseClassScreenBackButton.setBackground(Color.gray);
		ChooseClassScreenBackButton.setForeground(Color.white);
		ChooseClassScreenBackButton.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		ChooseClassScreenBackButton.addActionListener(CCSBHandler);
		
		//------FRAME ESTABLISHERS
		ClassPanel.add(CharacterClassLabel);
		WarriorClassPanel.add(WarriorClassButton);
		MageClassPanel.add(MageClassButton);
		ArcherClassPanel.add(ArcherClassButton);
		ChooseClassScreenBackButtonPanel.add(ChooseClassScreenBackButton);
		
		container.add(ClassPanel);
		container.add(WarriorClassPanel);
		container.add(MageClassPanel);
		container.add(ArcherClassPanel);
		container.add(ChooseClassScreenBackButtonPanel);
	}
	...
	public class ChooseClassScreenBackHandler implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			ClassPanel.setVisible(false);
			WarriorClassPanel.setVisible(false);
			MageClassPanel.setVisible(false);
			ArcherClassPanel.setVisible(false);
			ChooseClassScreenBackButtonPanel.setVisible(false);
			
			NameQuestionPanel.setVisible(true);
			PlayerNameInput.setVisible(true);
			BackButtonPanel.setVisible(true);
			NameInputPanel.setVisible(true);
			DifficultyPanel.setVisible(true);
			DifficultyEasyPanel.setVisible(true);
			DifficultyMediumPanel.setVisible(true);
			DifficultyHardPanel.setVisible(true);
		}
	}
}
